...
//    const int BackgroundHeight = 350;
    ...
    // The bubble blower
    //
    auto blower =  std::make_shared<BubbleBlower>(mImagesDir, true);
    ...
    //
    // The pulley on the blower. Driven by the motor pulley.
    // Radius=40pixels
    //
 ...
 * \return Shape object
 */
std::shared_ptr<Shape> Machine1Factory::CreatePost(int x, int y, int wid, int hit, wxColor color)
{
